  ...
  return (
    <div className="w-full max-w-md px-8 py-10 bg-white rounded-2xl shadow-xl border border-slate-100/80 transition-all duration-300 hover:shadow-2xl">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-slate-500">Access to All The Yards Services</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-lg border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#062c1a] focus:border-transparent transition-all"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-slate-200 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#062c1a] focus:border-transparent transition-all pr-12"
            />
            <button
              type="button"
